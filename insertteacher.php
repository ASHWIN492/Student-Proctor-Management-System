...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <br/><br/>  
    ...
    <a href="adminteacher.php" style="font-family: Verdana,sans-serif;">PROCTOR</a>
    <a href="admininsertstudent.php" style="font-family: Verdana,sans-serif;">ADD STUDENT</a>
    <a href="insertteacher.php" style="font-family: Verdana,sans-serif;">ADD PROCTOR</a>
  </div>
        ...
        <div class="row" >
          <div class="panel panel-default" style="opacity:0.9">
            <div class="panel-heading">  
              <center><h1 >PROCTOR REGISTRATION</h1></center>					
            </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><input type="text" class="form-control" name="name" placeholder="Enter Name"/>
                        <label style="color:#FF0000;display:none;">Enter Proctor's Name</label>
                      </td>
                    </tr> 
                    ...
                    <tr>
                      ...
                      <td><input type="text" class="form-control" name="idno" placeholder="Enter ID Card No."/>
                        <label style="color:#FF0000;display:none;">Enter Proctor's ID Card No.</label>
                      </td>
                    </tr> 
