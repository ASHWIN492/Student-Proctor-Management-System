...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background-image:url(bootstrap-3.1.1\images\111.png); background-size: cover; ">
		...
		<center>
		<img src="bootstrap-3.1.1\images\111.png" alt="Image" style="width: 350px; height: auto;">
			<h4 style="color:#800000; font-family: 'Cinzel', serif; font-weight: bold;">I.S.E DEPARTMENT</h4>
		</center>	
			...
			<input type="radio" value="admin"  name="membertype" />Admin &nbsp &nbsp <input type="radio" value="teacher" name="membertype" />Proctor
			<br /><br/>
			
			<center>		
			<input type="submit" value="LOGIN" class="btn btn-primary form-control btn-green" name="btn" style="font-size:14px; width: 100px;" /> 
			</center>
			</form>	
		</div>
	</body>
